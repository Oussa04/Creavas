package tn.meteor.creavas.kitchen.widget;
...
import tn.meteor.creavas.utils.multitouch.MoveGestureDetector;
import tn.meteor.creavas.utils.multitouch.RotateGestureDetector;
...
public class MotionView  extends FrameLayout {
    ...
    public void setEntities( List<MotionEntity> entities) {
     ...
     */
    public Bitmap getThumbnailImage(int backgroundColor) {
    ...
    private void updateOnLongPress(MotionEvent e) {
        ...
        if (selectedEntity != null) {
            ...
            if (selectedEntity.pointInLayerRect(p)) {
                moveEntityToFront(selectedEntity);
            }
        }
    }

    private void moveEntityToFront(@NonNull MotionEntity entity) {
